...
const Settings = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const updatedUser = { fullName, mssv, address, userId: user._id, email, class: classStudy };
              ...
              <div className="settings__container">
                <div className="settings__left">
                  <form className="settings__form" onSubmit={handleSubmit}>
                    ...
                    <label className={styles.textLabel} htmlFor="">Tên đầy đủ</label>
                    <input type="text" placeholder={user?.fullName} value={fullName} onChange={e => setFullName(e.target.value)} />
                    {
                      user.isAdmin === true || user.option === '3' ? <></> : <>
                        <label className={styles.textLabel} htmlFor="">Mã số</label>
                    ...
                    }
                    {
                      user.isAdmin === true || user.option === '3' || user.option === '2' ? <></> : <>
                        <label className={styles.textLabel} htmlFor="">Lớp</label>
                        <input type="text" placeholder={user?.class} value={classStudy} onChange={e => setClass(e.target.value)} />
                      </>
                    }
                    ...
                    <label className={styles.textLabel} htmlFor="">Email</label>
